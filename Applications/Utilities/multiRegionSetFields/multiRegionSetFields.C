...
Description
    ...
    IR: This is the multiRegion version based on the description given on:
        http://www.cfd-online.com/Forums/openfoam/105491-how-use-setfields-multiregionsolver.html
        (user karlvirgil).
...
// IR: Added the following single line
...
// IR: Commented out #   include "createMesh.H"
// IR: Added the following single line
